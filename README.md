...
You can create a person, or a customer, or a driver. A customer can create an order, and the order can be assigned to a driver, the driver then can deliver the package
